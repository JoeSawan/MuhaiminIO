...
void processCommand()
{
  ...
  case 1:
    ARPins(param1);
    break; // قراءة قيمة أنالوج
  case 2:
    RPINx(param1);
    break; // قراءة قيمة رقمية (غير مستخدم حالياً) يتم قراءة ققيمة المنفذ وتحليلهل بالجهاز للسرعة
  case 3:
    RPORT(param1);
    break; // قراءة قيمة منفذ
  case 4:
    WPORTD(param1, param2);
    break; // كتابة قيمة إلى منفذ
  case 5:
    RDDRS(param1);
    break; // قراءة سجل DDR
  case 6:  // ضبط خرج رقمي
...
int getdata(int index)
{
  ...
  { // التنقل للوصول إلى البارامتر المطلوب
    token = strtok(NULL, " ");
    if (token == NULL)
      return -1; // في حال عدم وجود بيانات كافية
  }
...
void RPORT(int I)
{
  ...
  case 4:
    ...
    break; // قراءة PORTD
  default:
    Serial.println("-1"); // في حال عدم وجود منفذ مطابق
  }
}
...
void WPORTD(int I, int val)
{
  ...
  case 2:
    PORTB = val;
    break; // كتابة إلى PORTB
  case 4:
    PORTD = val;
    break; // كتابة إلى PORTD
  }
}
...
void RDDRS(int I)
{
  ...
  case 2:
    ...
    break; // قراءة DDRB
  case 3:
    Serial.println(DDRC, DEC);
    break; // قراءة DDRC
  case 4:
    Serial.println(DDRD, DEC);
    break; // قراءة DDRD
  default:
    Serial.println("-1"); // في حال عدم وجود سجل مطابق
  }
}
